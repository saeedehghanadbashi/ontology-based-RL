...
class EdgeServer():
    def __init__(self, edge_id, loc):
        ...
        rnd_num = np.random.choice(np.arange(1, 4), p=[0.4, 0.3, 0.3])  
...
class Env():
    ...
    def ddpg_step_forward(self, a, r_dim, b_dim):
        ...
        for user_id in range(self.user_num):
            ...
            action = action_prioritization(s_, self.U[int(user_id)].req.resource, action1, action2, action3, "server_capability", self.E)             
...
def action_prioritization(s_, user_req_resource, action1, action2, action3, concept, E):
    action = action1
    Dict = {}
    if concept == "server_capability":
        ...
        print("user_req_resource: ", user_req_resource)
        print("server", action1, "_capability in obs: ", server1_capability)
        print("server", action2, "_capability in obs: ", server2_capability)
        print("server", action3, "_capability in obs: ", server3_capability)
        print("server", action1, "_capability: ", E[action1].capability)
